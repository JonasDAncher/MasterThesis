...
fn machine_integer_test () {
    ...
    /////////////////////////////
    <u32 as hacspec_lib::Integer>::ZERO();
    <u8  as hacspec_lib::Integer>::ONE();
    u128::TWO();
    let mut mi = u16::from_literal(1238_u128);
    // u16::from_hex_string(&String::from(""));
    mi = mi.get_bit(3);
    mi = mi.set_bit(<u16 as hacspec_lib::Integer>::ONE(), 3);
    ...
    let _ : bool = <u16 as hacspec_lib::Integer>::ONE().equal(u16::TWO());

    let _ : bool = <u16 as hacspec_lib::Integer>::ONE().greater_than(u16::TWO());
    let _ : bool = <u16 as hacspec_lib::Integer>::ONE().greater_than_or_equal(u16::TWO());
    let _ : bool = <u16 as hacspec_lib::Integer>::ONE().less_than(u16::TWO());
    let _ : bool = <u16 as hacspec_lib::Integer>::ONE().less_than_or_equal(u16::TWO());
